        ...
        <div className="advice__content">
          <div className="advice__description">
            ...
            <p className="advice__item-description">
              ...
              Atención psicológica con orientación psicoanalítica a adolescentes y adultos.
            </p>
          </div>
          <div className="advice__description">
            <h5 className="advice__item">Selección y Reclutamiento</h5>
            <p className="advice__item-description">
              Búsquedas de perfiles IT y generalistas para empresas y consultoras. Headhunting y selección de candidatos. Redacción de informes.
            </p>
          </div>
          <div className="advice__description">
            <h5 className="advice__item">Asesoría Laboral</h5>
            <p className="advice__item-description">
              Armados de CV. Consejos y asesoramiento para búsquedas y entrevistas laborales. Simulación de entrevistas para fortalecer la confianza y seguridad.
            </p>
          </div>
        </div>
      </div>
